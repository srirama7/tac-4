...
export const api = {
  ...
  async generateQuerySuggestion(request: QuerySuggestionRequest = {}): Promise<QuerySuggestionResponse> {
    return apiRequest<QuerySuggestionResponse>('/generate-query-suggestion', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
