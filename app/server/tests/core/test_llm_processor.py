...
class TestLLMProcessor:
    ...
    @patch('core.llm_processor.generate_sql_with_openai')
    def test_generate_sql_openai_priority_without_gemini(self, mock_openai_func):
        # Test that OpenAI has priority when both OpenAI and Anthropic keys exist (but no Gemini)
