...
### Step 13: Verify E2E test specification exists
- Confirm that `.claude/commands/e2e/test_nl_query_generator.md` already exists
...
- The E2E test file should define:
  - User Story for the feature
  - Test Steps covering setup, button presence, happy path, error handling
...
11. **E2E Validation**
    - E2E test file `.claude/commands/e2e/test_nl_query_generator.md` exists
